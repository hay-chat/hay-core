/**
 * Plugin SDK v2 Type Definitions
 *
 * These types define the contract between Hay Core and Plugin SDK v2.
 * SDK v2 uses a minimal manifest approach where metadata is fetched at runtime.
 */
