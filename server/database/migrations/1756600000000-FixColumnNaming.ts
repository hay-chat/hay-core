...
export class FixColumnNaming1756600000000 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        if (userColumnNames.includes('organizationid') && !userColumnNames.includes('organization_id')) {
        ...
        if (apiKeyColumnNames.includes('organizationid') && !apiKeyColumnNames.includes('organization_id')) {
        ...
        if (docColumnNames.includes('organizationid') && !docColumnNames.includes('organization_id')) {
            await queryRunner.query(`ALTER TABLE "documents" RENAME COLUMN "organizationid" TO "organization_id"`);
        }
