...
export class AddPluginInstanceLifecycleFields1758046520159 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "plugin_registry" ADD "max_concurrent_instances" integer NOT NULL DEFAULT '10'`,
    );
    await queryRunner.query(
      `ALTER TABLE "plugin_instances" ADD "last_activity_at" TIMESTAMP WITH TIME ZONE`,
    );
    await queryRunner.query(
      `ALTER TABLE "plugin_instances" ADD "priority" integer NOT NULL DEFAULT '0'`,
    );
  }
