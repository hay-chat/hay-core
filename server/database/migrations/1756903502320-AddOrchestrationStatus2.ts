...
export class AddOrchestrationStatus21756903502320 implements MigrationInterface {
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE INDEX "IDX_conversations_processing_locked_until" ON "conversations" ("processing_locked_until") WHERE (processing_locked_until IS NOT NULL)`);
    }
