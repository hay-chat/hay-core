...
export class AddImportFieldsToDocuments1756644604987 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."documents_import_method_enum" AS ENUM('upload', 'web', 'plugin')`);
        await queryRunner.query(`ALTER TABLE "documents" ADD "import_method" "public"."documents_import_method_enum" NOT NULL DEFAULT 'upload'`);
        await queryRunner.query(`ALTER TABLE "documents" ADD "source_url" character varying`);
        await queryRunner.query(`ALTER TABLE "documents" ADD "last_crawled_at" TIMESTAMP WITH TIME ZONE`);
    }
