...
export class AddDocumentAndPlaybookMessageTypes1757330695275 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."messages_type_enum" AS ENUM('Customer', 'System', 'HumanAgent', 'BotAgent', 'ToolCall', 'ToolResponse', 'Document', 'Playbook')`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."messages_type_enum_old" AS ENUM('BotAgent', 'Customer', 'HumanAgent', 'System', 'ToolCall', 'ToolResponse')`);
