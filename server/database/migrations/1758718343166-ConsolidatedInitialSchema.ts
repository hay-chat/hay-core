...
export class ConsolidatedInitialSchema1758718343166 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."documents_type_enum" AS ENUM('article', 'guide', 'faq', 'tutorial', 'reference', 'policy')`);
        await queryRunner.query(`CREATE TYPE "public"."documents_status_enum" AS ENUM('draft', 'published', 'archived', 'under_review')`);
        await queryRunner.query(`CREATE TYPE "public"."documents_visibility_enum" AS ENUM('public', 'private', 'internal')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."jobs_status_enum" AS ENUM('pending', 'queued', 'processing', 'completed', 'failed', 'cancelled', 'retrying')`);
        await queryRunner.query(`CREATE TYPE "public"."jobs_priority_enum" AS ENUM('0', '1', '2', '3')`);
