...
export class InitialSchema1756641295679 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE INDEX "idx_sessions_refresh_token_hash" ON "sessions" ("refresh_token_hash") `);
        await queryRunner.query(`CREATE INDEX "idx_sessions_user_id" ON "sessions" ("user_id") `);
        await queryRunner.query(`CREATE TABLE "embeddings" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "organization_id" uuid NOT NULL, "document_id" uuid, "page_content" text NOT NULL, "metadata" jsonb, "embedding" text, CONSTRAINT "PK_19b6b451e1ef345884caca1f544" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "embeddings_org_id_idx" ON "embeddings" ("organization_id") `);
        await queryRunner.query(`CREATE TABLE "playbooks" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "title" character varying(255) NOT NULL, "trigger" character varying(255) NOT NULL, "description" text, "instructions" jsonb, "kind" "public"."playbooks_kind_enum" NOT NULL DEFAULT 'custom', "required_fields" jsonb, "prompt_template" text, "is_system" boolean NOT NULL DEFAULT false, "status" "public"."playbooks_status_enum" NOT NULL DEFAULT 'draft', "organization_id" uuid, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_700979398c237ee843f513f51ce" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_fd8ff15d87714c6b6b955262c1" ON "customers" ("organization_id", "email") `);
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_e657a38782ca3690fa2fbf254b" ON "customers" ("organization_id", "external_id") `);
        ...
        await queryRunner.query(`ALTER TABLE "documents" ADD CONSTRAINT "FK_69427761f37533ae7767601a64b" FOREIGN KEY ("organization_id") REFERENCES "organizations"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "jobs" ADD CONSTRAINT "FK_3d9a2080fffe3e2c3b72fd56df2" FOREIGN KEY ("organization_id") REFERENCES "organizations"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "embeddings" ADD CONSTRAINT "FK_7b03f1649a7fd45dc933d67bcda" FOREIGN KEY ("organization_id") REFERENCES "organizations"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "embeddings" ADD CONSTRAINT "FK_af7cbcfb2b78ba6e749aa419dfa" FOREIGN KEY ("document_id") REFERENCES "documents"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "playbooks" ADD CONSTRAINT "FK_bc94e9eb46821ac889e0eb8ff8c" FOREIGN KEY ("organization_id") REFERENCES "organizations"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "agents" ADD CONSTRAINT "FK_28ac537f8c7bc3c96f7d1753ec4" FOREIGN KEY ("organization_id") REFERENCES "organizations"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "customers" ADD CONSTRAINT "FK_d2fc0e42b07d01fafc3fbb2bee3" FOREIGN KEY ("organization_id") REFERENCES "organizations"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "conversations" ADD CONSTRAINT "FK_9f32ead8384a1a92e073a7c006a" FOREIGN KEY ("agent_id") REFERENCES "agents"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "conversations" ADD CONSTRAINT "FK_c9f0434c15cacf894e996f69088" FOREIGN KEY ("customer_id") REFERENCES "customers"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "plugin_instances" ADD CONSTRAINT "FK_2640efc3355bdcf8627dde0348f" FOREIGN KEY ("plugin_id") REFERENCES "plugin_registry"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "plugin_instances" ADD CONSTRAINT "FK_3351804d975a13769f702c5b518" FOREIGN KEY ("organization_id") REFERENCES "organizations"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "plugin_instances" DROP CONSTRAINT "FK_3351804d975a13769f702c5b518"`);
        await queryRunner.query(`ALTER TABLE "plugin_instances" DROP CONSTRAINT "FK_2640efc3355bdcf8627dde0348f"`);
        ...
        await queryRunner.query(`ALTER TABLE "agents" DROP CONSTRAINT "FK_28ac537f8c7bc3c96f7d1753ec4"`);
        await queryRunner.query(`ALTER TABLE "playbooks" DROP CONSTRAINT "FK_bc94e9eb46821ac889e0eb8ff8c"`);
        await queryRunner.query(`ALTER TABLE "embeddings" DROP CONSTRAINT "FK_af7cbcfb2b78ba6e749aa419dfa"`);
        await queryRunner.query(`ALTER TABLE "embeddings" DROP CONSTRAINT "FK_7b03f1649a7fd45dc933d67bcda"`);
