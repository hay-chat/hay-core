...
export class AddConversationOrchestratorFields1756475800000 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."conversations_status_enum" AS ENUM('open', 'pending-human', 'resolved')`);
        await queryRunner.query(`ALTER TABLE "conversations" ADD "status" "public"."conversations_status_enum" NOT NULL DEFAULT 'open'`);
        await queryRunner.query(`ALTER TABLE "conversations" ADD "cooldown_until" TIMESTAMP WITH TIME ZONE`);
        await queryRunner.query(`ALTER TABLE "conversations" ADD "last_user_message_at" TIMESTAMP WITH TIME ZONE`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "conversations" DROP CONSTRAINT IF EXISTS "FK_conversations_agent"`);
        await queryRunner.query(`ALTER TABLE "conversations" ALTER COLUMN "agent_id" SET NOT NULL`);
        await queryRunner.query(`ALTER TABLE "conversations" ADD CONSTRAINT "FK_conversations_agent" FOREIGN KEY ("agent_id") REFERENCES "agents"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
