    ...
    <div class="max-w-4xl mx-auto">
      ...
      <div class="mb-8 text-center">
        ...
        <p class="text-gray-600">
          Simulate customer conversations to test the orchestrator
        </p>
        <NuxtLink
          to="/conversations"
        ...
        <CardContent class="space-y-4">
          ...
          <div class="flex justify-end space-x-2">
            <Button
              ...
              :disabled="
                !customerName || !customerEmail || isStartingConversation
              "
            >
      ...
      <Card v-if="activeConversation">
        ...
        <CardContent>
          <div class="space-y-2 text-sm">
            ...
            <div
              v-if="activeConversation.playbook_id"
            ...
            >
              <div>
                <div class="font-medium">
                  {{ conv.metadata?.customer_name || "Unknown" }}
                </div>
