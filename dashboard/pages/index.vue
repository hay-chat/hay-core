  ...
  <div class="space-y-8">
    ...
    <div class="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
      <Card>
        ...
        <CardContent>
          ...
          <p class="text-xs text-muted-foreground">
            <span class="text-green-600">+{{ metrics.newAgentsThisWeek }}</span> new this week
          </p>
        </CardContent>
      </Card>
      ...
      <Card>
        ...
        <CardContent>
          <div class="text-2xl font-bold">{{ formatNumber(metrics.totalConversations) }}</div>
          <p class="text-xs text-muted-foreground">
            <span class="text-green-600">+{{ metrics.conversationsGrowth }}%</span> from last month
          </p>
        </CardContent>
      </Card>
      ...
      <Card>
        ...
        <CardContent>
          ...
          <p class="text-xs text-muted-foreground">
            <span class="text-green-600">+{{ metrics.resolutionRateChange }}%</span> improvement
          </p>
        </CardContent>
      </Card>
      ...
      <Card>
        ...
        <CardContent>
          ...
          <p class="text-xs text-muted-foreground">
            <span class="text-green-600">-{{ metrics.responseTimeImprovement }}%</span> faster
          </p>
        </CardContent>
      </Card>
    </div>
...
useHead({
  title: 'Dashboard - Hay',
  meta: [{ name: 'description', content: 'Manage your AI agents and view performance metrics' }],
});
</script>
