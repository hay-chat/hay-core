    ...
    <div class="flex items-center justify-between">
      <div>
        ...
        <p class="text-muted-foreground">
          Manage Model Context Protocol actions for your agents
        </p>
      </div>
        ...
        <CardHeader>
          <div class="flex items-start justify-between">
            <div class="flex items-center space-x-3">
              ...
              >
                <component
                  :is="getActionIcon(action.category)"
            ...
            <div class="flex items-center space-x-2">
              ...
              <Button
                variant="ghost"
                size="sm"
                @click="showActionMenu(action.id)"
              >
          ...
          <div class="space-y-4">
              ...
              <div v-else class="space-y-1">
                ...
                >
                  ...
                  <div class="flex items-center space-x-2">
                    ...
                    <span v-if="param.required" class="text-red-500 text-xs"
                      >*</span
                    >
                  </div>
                </div>
            ...
            <div class="grid gap-2 text-sm">
              ...
              <div class="flex justify-between">
                ...
                <span class="font-medium text-green-600"
                  >{{ action.stats.successRate }}%</span
                >
              </div>
              <div class="flex justify-between">
                <span class="text-muted-foreground">Last Used:</span>
                <span class="font-medium">{{
                  formatDate(action.stats.lastUsed)
                }}</span>
              </div>
              <div class="flex justify-between">
            ...
            <div class="space-y-2">
              ...
              <div class="space-y-2">
                ...
                >
                  ...
                  <Input
                    v-model="
                      (testParameters[action.id] =
                        testParameters[action.id] || {})[param.name]
                    "
            ...
            <div v-if="testResults[action.id]" class="space-y-2">
              ...
              <div class="p-2 bg-muted rounded text-xs">
                <div class="flex items-center justify-between mb-1">
                  ...
                  <Badge
                    :variant="
                      testResults[action.id].success ? 'success' : 'destructive'
                    "
                  >
            ...
            <div class="flex space-x-2">
              ...
              <Button
                variant="outline"
                size="sm"
                @click="viewActionLogs(action.id)"
              >
...
const filteredActions = computed(() => {
  return actions.value.filter((action) => {
    ...
    const matchesCategory =
      !selectedCategory.value || action.category === selectedCategory.value;
    const matchesStatus =
      !selectedStatus.value || action.status === selectedStatus.value;
...
const testAction = async (actionId: string) => {
  ...
  try {
    ...
    testResults.value[actionId] = {
      success: true,
      data: mockResults[actionId as keyof typeof mockResults] || {
...
useHead({
  ...
  meta: [
    {
      name: "description",
      content: "Manage Model Context Protocol actions for your agents",
    },
  ],
});
</script>
