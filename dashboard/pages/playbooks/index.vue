    ...
    <div class="grid gap-4 md:grid-cols-4">
      <Card>
        ...
        <CardContent>
          ...
          <p class="text-xs text-muted-foreground">+{{ stats.newThisMonth }} this month</p>
        </CardContent>
      </Card>
        ...
        <CardHeader>
          <div class="flex items-start justify-between">
            <div class="space-y-2">
              ...
              <p class="text-sm text-muted-foreground">{{ playbook.description }}</p>
            </div>
        ...
        <CardContent>
          <div class="space-y-3">
            ...
            <div class="flex items-center justify-between text-sm">
              ...
              <span class="font-medium text-green-600">{{ playbook.successRate }}%</span>
            </div>
            <div class="flex items-center justify-between text-sm">
              <span class="text-muted-foreground">Last Updated:</span>
              <span class="font-medium">{{ formatDate(playbook.updatedAt) }}</span>
            </div>
          </div>
        </CardContent>
      </Card>
              ...
              >
                <td class="py-3 px-4">
                  <div>
                    ...
                    <div class="text-sm text-muted-foreground">{{ playbook.description }}</div>
                  </div>
                </td>
                <td class="py-3 px-4">
                  <Badge variant="outline">{{ getCategoryLabel(playbook.category) }}</Badge>
                </td>
                ...
                <td class="py-3 px-4 text-sm text-green-600">{{ playbook.successRate }}%</td>
                <td class="py-3 px-4 text-sm">{{ formatDate(playbook.updatedAt) }}</td>
                <td class="py-3 px-4">
                  <div class="flex items-center space-x-2">
...
const playbooks = ref([
  ...
  },
  {
    ...
    description: 'Captures lead information and schedules product demonstrations',
    category: 'sales',
    status: 'active',
...
const filteredPlaybooks = computed(() => {
  return playbooks.value.filter((playbook) => {
    ...
    const matchesCategory = !selectedCategory.value || playbook.category === selectedCategory.value;
...
useHead({
  ...
  meta: [{ name: 'description', content: 'Manage automated conversation flows and responses' }],
});
</script>
