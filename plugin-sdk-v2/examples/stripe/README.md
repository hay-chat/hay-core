...
This is a complete example plugin for the Hay Plugin SDK v2, demonstrating all features and best practices.
...
- **plugin-sdk-v2/sdk/**: SDK implementation source code
- **plugin-sdk-v2/runner/**: Worker process implementation
